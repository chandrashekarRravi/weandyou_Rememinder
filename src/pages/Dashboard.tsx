...
import EntryFeedbackBox from '../components/EntryFeedbackBox';
                                                            ...
                                                            <div className="p-4 sm:p-6 xl:px-12 bg-white sm:bg-transparent rounded-xl border border-gray-100 sm:border-none shadow-sm sm:shadow-none">
                                                                ...
                                                                <div className="flex flex-col lg:flex-row gap-6">
                                                                    ...
                                                                    <div className="flex lg:flex-col flex-wrap items-center justify-center gap-4 lg:py-8 lg:px-2 relative">
                                                                        ...
                                                                        {/* Only enabled when: non-Client role, entry is Pending, on latest iteration */}
                                                                        {(() => {
                                                                            ...
                                                                            return (
                                                                                <div className="flex flex-col items-center justify-center relative min-w-[60px]">
                                                                                    <button
                                                                                        ...
                                                                                        disabled={!isLatestIteration}
                                                                                        className={`w-12 h-12 rounded-full border flex items-center justify-center transition-colors shrink-0 shadow-sm z-10 ${isLatestIteration
                                                                                            ? 'border-gray-400 bg-white text-gray-700 hover:bg-gray-100 cursor-pointer'
                                                                                            : 'border-gray-200 bg-gray-50 text-gray-300 cursor-not-allowed'
                                                                                            }`}
                                                                                        title={!isLatestIteration ? 'Navigate to the latest iteration' : 'Add New Iteration'}
                                                                                    >
                                                                    ...
                                                                    <div className="flex-1 flex gap-4">
                                                                        <EntryFeedbackBox entry={entry} iterIdx={iterIdx} currentMediaGroupLength={currentMediaGroup.length} />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </motion.div>
